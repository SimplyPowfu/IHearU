...
// IMPORT I18N
import { Link } from '@/i18n/routing'; // Usa il routing personalizzato
import { getTranslations } from 'next-intl/server'; // Traduzioni Server-Side

export const dynamic = 'force-dynamic';

export default async function HomePage() {
  // 1. Inizializza Traduzioni e Supabase in parallelo
  ...
  return (
    <main className="flex flex-col items-center overflow-hidden bg-background text-white min-h-screen">
      ...
      <section className="relative z-10 w-full flex flex-col items-center justify-center text-center px-6 pt-32 pb-20">
        ...
        <p className="max-w-2xl text-lg md:text-xl text-gray-400 mb-10 leading-relaxed font-sans whitespace-pre-line">
          {t('hero.subtitle')}
        </p>
      ...
      <section className="relative z-10 w-full max-w-7xl px-6 py-32">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="hover:border-success/50 transition-colors group">
            ...
            <h3 className="text-2xl font-bold mb-3 text-white font-display group-hover:text-green-400 transition-colors">{t('how_it_works.step3_title')}</h3>
            <p className="text-gray-400 leading-relaxed font-sans">
